...
<body>
	...
	<form action="${contextPath}/student/viewAssign" method="post">
		<table class="table table-striped">
			...
			<tbody>
 	        ...
 	        <td><a href="${contextPath}/student/uploadAssign?id=<c:out value='${Assignment.assignId}' />">Upload</a></td>
 	         <td><a href="${contextPath}/student/checkScore?id=<c:out value='${Assignment.assignId}' />">CheckScore</a></td>
					</tr>
