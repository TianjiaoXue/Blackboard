...
<title>Professor view assignment</title>
<style>
h1 {
	color: #558B2F;
	font-family: verdana;
...
<div class="container">
	<h2>Please select a course to view assignment</h2>

	<form:form action="${contextPath}/professor/selectCourseAssign" method="post"
		...
		<table class="table table-striped">
			...
			<tr>
				<td colspan="2"><input type="submit" value="Search Assignment" /></td>
			</tr>
		</table>
	</form:form>
</div>
