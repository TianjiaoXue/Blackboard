...
<title>Professor-sooreAssign</title>
...
<body>
	...
	<h2>Assignment Details</h2>
		...
		<form action="${contextPath}/professor/scoreAssign" method="post">
		...
		<table class="table table-striped">
			...
			<h2>Student upload Assignments</h2>
            <table class="table table-striped">
			<tr>
			       <td>saId</td>
			       <td>userId</td>
				...
				<c:forEach var="StudentAssignment" items="${saList}">
				<tr>
                        
						<td>${StudentAssignment.saId}</td>

						<td>${StudentAssignment.student.userId}</td>

						<td>${StudentAssignment.expire}</td>

						<td>${StudentAssignment.file}</td>
						
				        <td><input type="text" name="scores">
				      </td>			        
					</tr>
					  <input type="hidden" name="saId" value="${StudentAssignment.saId}"/>
				</c:forEach>
